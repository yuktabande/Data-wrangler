...
interface LovableViteTanstackOptions {
     ...
     *   bundling.
     * - **`true`**: force-on with package defaults (`cloudflare-module` preset,
     *   `dist/server` + `dist/client` layout). Use this in non-Lovable
     *   environments where you still want the Nitro deploy bundle.
     * - **object**: force-on, with these overrides on top of the defaults.
